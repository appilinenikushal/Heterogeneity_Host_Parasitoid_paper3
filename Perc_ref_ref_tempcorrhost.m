function [mean_temp_corr ] = Perc_ref_ref_tempcorrhost(L,l,g,eh,ep,t,p_location,p_density,h_indices,sites)
...
tempcorr_ts = cell(1,100); %storing timeseries for each of the 100
for i=1:100
...
temp_corr = temp_corr(~isnan(temp_corr)); %removing islands
